...
Fluid.events = {
  ...
  billboard: function() {
    ...
    console.log('%c ', 'padding:100px 120px;background:url("http://121.196.196.21:8080/temp/favicon.jpg") no-repeat;');
  	console.log("MY CAT SAY WELCOME!");
  	console.log("EMAIL: elliot_hsu@163.com")
  }
};
